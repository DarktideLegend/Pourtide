...
VALUES (7595, 'choriziterefineda', 1, '2024-07-26 02:57:44') /* Generic */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (7595,   1,        128) /* ItemType - Misc */
     , (7595,   3,         39) /* PaletteTemplate - Black */
     , (7595,   5,         50) /* EncumbranceVal */
     , (7595,   8,         50) /* Mass */
...
{
  "LastModified": "2024-07-25T19:57:45.5279907-07:00",
  "ModifiedBy": "pourman",
  "Changelog": [],
  "UserChangeSummary": "remove burden",
  "IsDone": false
}
*/
