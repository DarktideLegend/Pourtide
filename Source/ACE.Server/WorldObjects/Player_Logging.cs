...
namespace ACE.Server.WorldObjects
{
    partial class Player
    {
        ...
        /// </summary>
        public string ClientID => $"{Session?.EndPointS2C.Address?.ToString()}" ?? "UNKNOWN";
    ...
    public class PlayerTeleportEntry : TracedEntry
    {
        ...
        public string InstanceTo { get; set; }
    ...
    public class PlayerItemUseEntry : TracedEntry
    {
        ...
        public string PlayerInstance { get; set; }

        public override string ToString() =>
            $"{W("CHAR", PlayerName)} Item:{W("WEENIE", WeenieID)} {W("GUID", ItemGuid.ToString())} {W("ITEM_NAME", ItemName.ToString())} {W("ITEMINST", ItemInstance)} {W("PLAYERINST", PlayerInstance)} Uses:{ItemName}";
    }
}
