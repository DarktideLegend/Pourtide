    ...
    public static class DefaultPropertyManager
    {
        ...
        public static readonly ReadOnlyDictionary<string, Property<double>> DefaultDoubleProperties =
            DictOf(
                ...
                ("pvp_dmg_mod_war", new Property<double>(1, "Scales the amount of damage for war magic")),
                ("pvp_dmg_mod_war_variance", new Property<double>(1, "Scales the low end for war magic bolts and arcs without effecting top end.  Values under 1 will reduce the variance and increase min dmg by the amount the variance was reduced.  Values over 1 will increase variance and reduce min dmg to match.")),
                ("pvp_dmg_mod_war_streak", new Property<double>(1, "Scales the amount of damage for war streaks")),
                ("pvp_dmg_mod_war_blast", new Property<double>(1, "Scales the amount of damage for war blasts")),
                ("pvp_dmg_mod_war_cb_crit", new Property<double>(1, "Scales the amount of CB crit damage for war magic.")),
                ("pvp_dmg_mod_war_cs_crit", new Property<double>(1, "Scales the amount of CS crit damage for war magic.")),
                ("pvp_dmg_mod_war_cs_dmg", new Property<double>(1, "Scales the amount of CS damage for war magic for all hits (both crits and non-crits).")),
                ("pvp_dmg_mod_void", new Property<double>(1, "Scales the amount of damage players take from Void Magic (not including streaks and DOTs which have their own mods)")),
                ("pvp_dmg_mod_void_streak", new Property<double>(1, "Scales the amount of damage for void streaks.")),
                ("pvp_dmg_mod_void_dot", new Property<double>(1, "Scales the amount of damage for void DOTs.")),
                ("pvp_dmg_mod_void_crit", new Property<double>(1, "Scales the amount of crit damage for void magic.")),
                ("pvp_dmg_mod_void_cb_crit", new Property<double>(1, "Scales the amount of CB crit damage for void magic.")),
                ("pvp_dmg_mod_void_variance", new Property<double>(1, "Scales the low end for void magic bolts and arcs without effecting top end.  Values under 1 will reduce the variance and increase min dmg by the amount the variance was reduced.  Values over 1 will increase variance and reduce min dmg to match.")),
                ("pvp_dmg_mod_phantom", new Property<double>(1, "Scales the amount of damage for phantom")),
                ("pvp_dmg_mod_hollow", new Property<double>(1, "Scales the amount of damage for hollow")),
                ("pvp_dmg_mod_cb", new Property<double>(1, "Scales the amount of damage for crippling blow")),
                ("pvp_dmg_mod_ar", new Property<double>(1, "Scales the amount of damage for armor rending")),
                ("pvp_dmg_mod_cs", new Property<double>(1, "Scales the amount of damage for critical strike")),
                ("pvp_dmg_mod_fw", new Property<double>(1, "Scales the amount of damage for Finesse Weapons")),
                ("pvp_dmg_mod_fw_cb", new Property<double>(1, "Scales the amount of damage for FW CB.")),
                ("pvp_dmg_mod_fw_cb_crit", new Property<double>(1, "Scales the amount of damage for FW CB Crit.")),
                ("pvp_dmg_mod_fw_cs", new Property<double>(1, "Scales the amount of damage for FW CS.")),
                ("pvp_dmg_mod_fw_ar", new Property<double>(1, "Scales the amount of damage for FW AR.")),
                ("pvp_dmg_mod_fw_hollow", new Property<double>(1, "Scales the amount of damage for FW Hollow.")),
                ("pvp_dmg_mod_fw_phantom", new Property<double>(1, "Scales the amount of damage for war FW Phantom.")),
                ("pvp_dmg_mod_lw", new Property<double>(1, "Scales the amount of damage for Light Weapons")),
                ("pvp_dmg_mod_lw_cb", new Property<double>(1, "Scales the amount of damage for LW CB.")),
                ("pvp_dmg_mod_lw_cb_crit", new Property<double>(1, "Scales the amount of damage for LW CB Crit.")),
                ("pvp_dmg_mod_lw_cs", new Property<double>(1, "Scales the amount of damage for LW CS.")),
                ("pvp_dmg_mod_lw_ar", new Property<double>(1, "Scales the amount of damage for LW AR.")),
                ("pvp_dmg_mod_lw_hollow", new Property<double>(1, "Scales the amount of damage for LW Hollow.")),
                ("pvp_dmg_mod_lw_phantom", new Property<double>(1, "Scales the amount of damage for LW Phantom.")),
                ("pvp_dmg_mod_lw_triplestrike", new Property<double>(1, "Scales the amount of damage for LW Triple Strike weapons.")),
                ("pvp_dmg_mod_lw_cb_crit_triplestrike", new Property<double>(1, "Scales the amount of Crit damage for LW Triple Strike weapons.")),
                ("pvp_dmg_mod_hw", new Property<double>(1, "Scales the amount of damage for Heavy Weapons")),
                ("pvp_dmg_mod_hw_cb", new Property<double>(1, "Scales the amount of damage for HW CB.")),
                ("pvp_dmg_mod_hw_cb_crit", new Property<double>(1, "Scales the amount of damage for HW CB Crit.")),
                ("pvp_dmg_mod_hw_cs", new Property<double>(1, "Scales the amount of damage for HW CS.")),
                ("pvp_dmg_mod_hw_ar", new Property<double>(1, "Scales the amount of damage for HW AR.")),
                ("pvp_dmg_mod_hw_hollow", new Property<double>(1, "Scales the amount of damage for HW Hollow.")),
                ("pvp_dmg_mod_hw_phantom", new Property<double>(1, "Scales the amount of damage for HW Phantom.")),
                ("pvp_dmg_mod_hw_multistrike", new Property<double>(1, "Scales the amount of damage for HW Multi Strike weapons.")),
                ("pvp_dmg_mod_hw_cb_crit_multistrike", new Property<double>(1, "Scales the amount of Crit damage for HW Multi Strike weapons.")),
                ("pvp_dmg_mod_2h", new Property<double>(1, "Scales the amount of damage for Two Handed Weapons")),
                ("pvp_dmg_mod_2h_cb", new Property<double>(1, "Scales the amount of damage for v CB.")),
                ("pvp_dmg_mod_2h_cb_crit", new Property<double>(1, "Scales the amount of damage for 2H CB Crit.")),
                ("pvp_dmg_mod_2h_cs", new Property<double>(1, "Scales the amount of damage for 2H CS.")),
                ("pvp_dmg_mod_2h_ar", new Property<double>(1, "Scales the amount of damage for 2H AR.")),
                ("pvp_dmg_mod_2h_hollow", new Property<double>(1, "Scales the amount of damage for 2H Hollow.")),
                ("pvp_dmg_mod_2h_phantom", new Property<double>(1, "Scales the amount of damage for 2H Phantom.")),
                ("pvp_dmg_mod_xbow", new Property<double>(1, "Scales the amount of damage for Xbow")),
                ("pvp_dmg_mod_xbow_cb", new Property<double>(1, "Scales the amount of damage for Xbow CB.")),
                ("pvp_dmg_mod_xbow_cb_crit", new Property<double>(1, "Scales the amount of damage for Xbow CB Crit.")),
                ("pvp_dmg_mod_xbow_cs", new Property<double>(1, "Scales the amount of damage for Xbow CS.")),
                ("pvp_dmg_mod_xbow_ar", new Property<double>(1, "Scales the amount of damage for Xbow AR.")),
                ("pvp_dmg_mod_xbow_hollow", new Property<double>(1, "Scales the amount of damage for Xbow Hollow.")),
                ("pvp_dmg_mod_xbow_phantom", new Property<double>(1, "Scales the amount of damage for Xbow Phantom.")),
                ("pvp_dmg_mod_bow", new Property<double>(1, "Scales the amount of damage for hollow")),
                ("pvp_dmg_mod_bow_cb", new Property<double>(1, "Scales the amount of damage for Bow CB.")),
                ("pvp_dmg_mod_bow_cb_crit", new Property<double>(1, "Scales the amount of damage for Bow CB Crit.")),
                ("pvp_dmg_mod_bow_cs", new Property<double>(1, "Scales the amount of damage for Bow CS.")),
                ("pvp_dmg_mod_bow_ar", new Property<double>(1, "Scales the amount of damage for Bow AR.")),
                ("pvp_dmg_mod_bow_hollow", new Property<double>(1, "Scales the amount of damage for Bow Hollow.")),
                ("pvp_dmg_mod_bow_phantom", new Property<double>(1, "Scales the amount of damage for Bow Phantom.")),
                ("pvp_dmg_mod_tw", new Property<double>(1, "Scales the amount of damage for hollow")),
                ("pvp_dmg_mod_tw_cb", new Property<double>(1, "Scales the amount of damage for TW CB.")),
                ("pvp_dmg_mod_tw_cb_crit", new Property<double>(1, "Scales the amount of damage for TW CB Crit.")),
                ("pvp_dmg_mod_tw_cs", new Property<double>(1, "Scales the amount of damage for TW CS.")),
                ("pvp_dmg_mod_tw_ar", new Property<double>(1, "Scales the amount of damage for TW AR.")),
                ("pvp_dmg_mod_tw_hollow", new Property<double>(1, "Scales the amount of damage for TW Hollow.")),
                ("pvp_dmg_mod_tw_phantom", new Property<double>(1, "Scales the amount of damage for TW Phantom.")),
                ("pvp_cs_critrate_mod", new Property<double>(1, "Scales the crit rate for CS")),
                ("pvp_void_hybrid_mod", new Property<double>(1, "Scales the amount of DOT damage when a player is a hybrid void.")),
                ("pvp_dmg_mod_void_dot_rating_reduction", new Property<double>(1, "Scales the amount of rating reduction received from a void DOT that's cast by a PK on another player.")),
                ("pvp_ratings_mod_dmg", new Property<double>(1, "Scales the bonus received from dmg and dmg reduction ratings during pvp")),
                ("pvp_ratings_mod_critdmg", new Property<double>(1, "Scales the bonus received from crit dmg and crit dmg reduction ratings during pvp")),
